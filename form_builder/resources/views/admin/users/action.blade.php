<div class="d-flex align-items-center">
    <a class="d-inline me-3 btn btn-success" href="{{ route('users.edit', $id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Edit User')}}">
        <i class="fa fa-pencil" aria-hidden="true"></i> Edit
    </a>

    <div class="d-flex align-items-center" style="height: 20px;"> 
      <a  class="d-inline me-3 btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete{{ $id }}">
        Delete
      </a>
    </div>
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="post" action="{{ route('users.destroy',$id) }}" class="pull-right">
                    {{csrf_field()}}
                    {{method_field("DELETE")}}
